...
# 엑셀로 저장하기 위한 변수
RESULT_PATH = './public/python'  # 결과 저장할 경로
...
def crawler(maxpage, query, sort, s_date, e_date):
    ...
    while page <= maxpage_t:
        ...
        Result.extend(title_text)
        Result.extend(date_text)
        Result.extend(source_text)
        Result.extend(contents_text)
...
if __name__ == '__main__':
    main("1", "삼성전자", "0", "2019.05.20", "2019.06.01")  # direct input 설정
    print(Result)
